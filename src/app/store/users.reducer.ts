...
export const usersReducer = createReducer(
    ...
    //These reducers take place AFTER the request has been sent and the info updated in the backend. So, to reset the form after the request,
    //we put 'user: {... user}'. Both in addSuccess and in updateSuccess.
